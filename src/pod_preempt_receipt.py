"""Pod Preempt Receipt — SCAFFOLD STUB.

Company lens: Runpod (independent; no affiliation).
Bottleneck: Spot/preemptible GPU pods die without structured recovery receipts for agents.
...
class PodPreemptReceipt:
    ...
    - `evaluate(req)` returns a PodPreemptReceiptReceipt
    ...
    def evaluate(self, req: PodPreemptReceiptRequest) -> PodPreemptReceiptReceipt:
        ...
        if reasons:
            ...
            return PodPreemptReceiptReceipt(
